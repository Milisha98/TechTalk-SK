# 📄 **Semantic Kernel Demo Application — Requirements Specification**
...
- **Outstanding balance**  
  - “Acme Automotive currently has an outstanding balance of \$42,300 across 3 unpaid invoices.”

- **Payment timeliness**  
  - “They consistently pay 30–45 days late.”

- **Anomalies**  
  - “Two unusually large payments were made in October.”

- **Trend**  
  - “Their outstanding balance has been trending upward over the last 3 months.”
...
1.  
   > “Show me the current outstanding balance and recent payment behaviour for Blue Horizon Logistics.”

2.  
   > “Which customers have increasing outstanding balances over the last 3 months?”
...
- **Console UI** (simple, universally understood baseline for demo)  
...
- Act as a financial analyst AI assistant
- Use available functions to retrieve customer data
- Analyze payment patterns, anomalies, and trends
- Provide actionable business insights with specific numbers and dates
...
## **3.6 User Interface (Console)**

### **Requirements**
- Console-based chat interface  
- Interactive input/output loop  
- Display example questions on startup  
- Each user message triggers `ProcessUserMessageAsync`  
- Display assistant responses in console  
- Simple, functional baseline that everyone understands
...
1. Full C# solution  
2. CSV data files  
3. Semantic Kernel setup with automatic function calling  
4. ErpDataPlugin implementation with granular functions  
5. ChatService with system prompt  
6. Console chat interface  
7. README with:
   - Setup instructions  
   - How to run  
   - Example questions
